...
- [ ] Legacy-contract gap decisions (Kam/Shinae, from the Q-219317 signed-contract comparison): company counter-signature (single vs dual signer)? T&Cs inline vs URL reference (confirm)? customer-appendix bundling into the signed PDF (build)? print Account Manager? Ship To? per-line Geography?
