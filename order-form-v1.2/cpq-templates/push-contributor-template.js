...
(async () => {
  ...
  const columns = [
    ...
    ["OF-C1-LD10", "Publication and product", 10, "SBQQ__ProductName__c", 24, "Left", "OF-C1-S41"],
    ["OF-C1-LD20", "Content", 20, "Order_Form_Content__c", 28, "Left", "OF-C1-S41"],
    ["OF-C1-LD50", "Start date", 50, "Start_Date_SUN_Report__c", 9, "Center", "OF-C1-S41"],
    ["OF-C1-LD60", "End date", 60, "End_Date_SUN_Report__c", 9, "Center", "OF-C1-S41"],
    ["OF-C1-LD25", "List price", 65, "SBQQ__ListPrice__c", 10, "Right", "OF-C1-S41"],
    ["OF-C1-LD27", "Discount", 67, "SBQQ__AdditionalDiscount__c", 8, "Right", "OF-C1-S41"],
