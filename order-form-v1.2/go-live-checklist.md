...
- [ ] Smoke test: one internal quote end-to-end with an internal test signer. DO NOT generate Order Forms in PROD until the throttled fields land (template cites them) - Kam hit the expected "Bad Request" on Q-219317 (24 Aug, no residue); template renamed in PROD to "zz DO NOT USE - Subscription Order Form (live 1 Sep)" so reps steer clear. Rename back at all-clear.
